...
def get_executor_param_injections(
    ...
    """Return extra parameters to merge into skill arguments.

    Merges config-driven injections that are specific to the invoked skill/action.
    """
    _ = (skill_name, action, db_path, session_id)
    return {}
